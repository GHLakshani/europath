...
<main id="js-page-content" role="main" class="page-content">
    ...
    <div class="subheader">
        <h1 class="subheader-title">
            <i class='subheader-icon fal fa-chart-area'></i> Create Testimonial <span class='fw-300'></span>
        </h1>
    ...
    <div class="row">
        <div class="col-xl-12">
            <div id="panel-1" class="panel">
                <div class="panel-hdr">
                    <h2>
                        {{-- Create <span class="fw-300"><i>Testimonial</i></span> --}}
                    </h2>
                ...
                <div class="panel-container show">
                    <div class="panel-content">
                        ...
                        <form action="{{ route('testimonial.store') }}" enctype="multipart/form-data" method="post" id="user-form" class="smart-form row" autocomplete="off" data-parsley-validate>
                            @csrf
                            ...
                            <div class="mb-3 col-6">
                                <div class="form-group">
                                    ...
                                    <input type="file" id="icon" name="icon" class="form-control" accept="image/*" value="{{ old('icon') }}" required>
                            ...
                            <div class="mb-3 col-12">
                                <div class="form-group">
                                    ...
                                    <textarea id="message" rows="3" name="message" class="form-control" required>{{ old('message') }}</textarea>
