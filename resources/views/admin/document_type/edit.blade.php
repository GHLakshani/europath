...
@section('Name', 'Update Document Type ')
...
<main id="js-page-content" role="main" class="page-content">
    ...
    <div class="subheader">
        <h1 class="subheader-Name">
            <i class='subheader-icon fal fa-chart-area'></i> Update Document Type  <span class='fw-300'></span>
        </h1>
    ...
    <div class="row">
        <div class="col-xl-12">
            <div id="panel-1" class="panel">
                <div class="panel-hdr">
                    <h2>
                        {{-- Update <span class="fw-300"><i>document-type</i></span> --}}
                    </h2>
                ...
                <div class="panel-container show">
                    <div class="panel-content">
                        ...
                        <form action="{{ route('document-type.update',$documentType->id) }}" enctype="multipart/form-data" method="post" id="user-form" class="smart-form row" autocomplete="off" >
                            @csrf
                            @method('put')
                            ...
                            <div class="mb-3 col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="name" name="name" class="form-control" @if (isset($documentType->name)) value="{{ $documentType->name }}" @endif>
