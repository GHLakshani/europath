...
<main id="js-page-content" role="main" class="page-content">
    ...
    <div class="subheader">
        <h1 class="subheader-title">
            <i class='subheader-icon fal fa-chart-area'></i> Sub Dealer<span class='fw-300'></span>
        </h1>
    ...
    <div class="row">
        <div class="col-xl-12">
            <div id="panel-1" class="panel">
                <div class="panel-hdr">
                    <h2>
                        {{-- sub-dealer <span class="fw-300"><i>list</i></span> --}}
                    </h2>
                </div>
...
<script>
    $(document).ready(function() {
        var table = $('#dt-basic-example').dataTable({
            ...
            searching: true,
            ajax: {
                url: "{{ route('sub-dealer.get-sub-dealer') }}",
