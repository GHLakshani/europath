...
@section('Name', 'Update Sub Dealer ')
...
<main id="js-page-content" role="main" class="page-content">
    ...
    <div class="subheader">
        <h1 class="subheader-Name">
            <i class='subheader-icon fal fa-chart-area'></i> Update Sub Dealer  <span class='fw-300'></span>
        </h1>
    ...
    <div class="row">
        <div class="col-xl-12">
            <div id="panel-1" class="panel">
                <div class="panel-hdr">
                    <h2>
                        {{-- Update <span class="fw-300"><i>sub-dealer</i></span> --}}
                    </h2>
                ...
                <div class="panel-container show">
                    <div class="panel-content">
                        ...
                        <form action="{{ route('sub-dealer.update',$sub_dealer->id) }}" enctype="multipart/form-data" method="post" id="user-form" class="smart-form row" autocomplete="off" >
                            @csrf
                            @method('put')
                            ...
                            <div class="mb-3 col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="name" name="name" class="form-control" @if (isset($sub_dealer->name)) value="{{ $sub_dealer->name }}" @endif>
                            ...
                            <div class="mb-3 col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="nic" name="nic" class="form-control"
                                        @if (isset($sub_dealer->nic)) value="{{ $sub_dealer->nic }}" @endif>
                            ...
                            <div class="mb-3 col-6">
                                <div class="form-group">
                                    ...
                                    <input type="tel" id="phone" name="phone" @if (isset($sub_dealer->phone)) value="{{ $sub_dealer->phone }}" @endif
                                        class="form-control">
                                    @error('phone')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="mb-3 col-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" id="commission_percentage" name="commission_percentage" @if (isset($sub_dealer->commission_percentage)) value="{{ $sub_dealer->commission_percentage }}" @endif
                                        class="form-control">
