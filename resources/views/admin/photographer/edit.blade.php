...
@section('Name', 'Update photographer ')
...
<main id="js-page-content" role="main" class="page-content">
    ...
    <div class="subheader">
        <h1 class="subheader-Name">
            <i class='subheader-icon fal fa-chart-area'></i> Update photographer  <span class='fw-300'></span>
        </h1>
    ...
    <div class="row">
        <div class="col-xl-12">
            <div id="panel-1" class="panel">
                <div class="panel-hdr">
                    <h2>
                        {{-- Update <span class="fw-300"><i>photographer</i></span> --}}
                    </h2>
                ...
                <div class="panel-container show">
                    <div class="panel-content">
                        ...
                        <form action="{{ route('photographer.update',$photographer->id) }}" enctype="multipart/form-data" method="post" id="user-form" class="smart-form row" autocomplete="off" >
                            @csrf
                            @method('put')
                            ...
                            <div class="mb-6 col-6">
                                <div class="form-group">
                                    <label class="form-label" for="photographer_name">Name <span style="color: red">*</span></label>
                                    <input type="text" id="photographer_name" style="margin-top: 2%" name="photographer_name" class="form-control" @if (isset($photographer->photographer_name)) value="{{ $photographer->photographer_name }}" @endif>
                            ...
                            <div class="mb-6 col-6">
                                <div class="form-group">
                                    <label class="form-label" for="photographer_contactno">Contact No <span style="color: red">*</span></label>
                                    <input type="text" id="photographer_contactno" style="margin-top: 2%" name="photographer_contactno" class="form-control" @if (isset($photographer->photographer_contactno)) value="{{ $photographer->photographer_contactno }}" @endif>
                                    <div class="invalid-feedback">Name is required, you missed this one.</div>
                            ...
                            <div class="mb-6 col-6">
                                <div class="form-group">
                                    <label class="form-label" for="photographer_email">Email <span style="color: red">*</span></label>
                                    <input type="text" id="photographer_email" style="margin-top: 2%" name="photographer_email" class="form-control" @if (isset($photographer->photographer_email)) value="{{ $photographer->photographer_email }}" @endif>
                                    <div class="invalid-feedback">Name is required, you missed this one.</div>
                            ...
                            <div class="mb-6 col-6">
                                <div class="form-group">
                                    <label class="form-label" for="coat_per_each_photo">Cost per Photograph <span style="color: red">*</span></label>
                                    <input type="text" id="coat_per_each_photo" style="margin-top: 2%" name="coat_per_each_photo" class="form-control" @if (isset($photographer->coat_per_each_photo)) value="{{ $photographer->coat_per_each_photo }}" @endif>
                                    <div class="invalid-feedback">Name is required, you missed this one.</div>
                            ...
                            <div class="mb-3 col-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" id="order" name="order" class="form-control" value="{{ $photographer->order }}">
                                    @error('order')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
    ...
    <script>
       $(document).ready(function() {
            ...
            $('#js-submit-btn').click(function(event) {
                ...
                const NameInput = $('#photographer_name');
