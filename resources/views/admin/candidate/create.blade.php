    ...
    <main id="js-page-content" role="main" class="page-content">
        ...
        <div class="subheader">
            <h1 class="subheader-title">
                <i class='subheader-icon fal fa-chart-area'></i> Create Candidate <span class='fw-300'></span>
            </h1>
        ...
        <div class="row">
            <div class="col-xl-12">
                <div id="panel-1" class="panel">
                    <div class="panel-hdr">
                        <h2>
                            {{-- Create <span class="fw-300"><i>Candidate</i></span> --}}
                        </h2>
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            ...
                            <form action="{{ route('candidate.store') }}" enctype="multipart/form-data" method="post"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="contact_number_1" class="form-control" value="{{ old('contact_number_1') }}">
                                </div>

                                <div class="col-md-6">
                                    <label>Contact No 2</label>
                                    <input type="text" name="contact_number_2" class="form-control" value="{{ old('contact_number_2') }}">
                                </div>

                                <div class="col-md-6">
                                    <label>Nationality</label>
                                    <input type="text" name="nationality" class="form-control" value="{{ old('nationality','Sri Lankan') }}">
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" name="no_of_children" class="form-control" value="{{ old('no_of_children') }}">
                                </div>
                                ...
                                <div id="education-wrapper">
                                    <div class="mb-2 row education-row">
                                        <div class="col-4">
                                            <input type="text" name="educations[0][institute_name]" class="form-control" placeholder="Institute">
                                        </div>
                                        <div class="col-4">
                                            <input type="text" name="educations[0][course]" class="form-control" placeholder="Course">
                                        </div>
                                        <div class="col-2">
                                            <input type="text" name="educations[0][duration]" class="form-control" placeholder="Duration">
                                        </div>
                                        <div class="col-1">
                                ...
                                <div id="experience-wrapper">
                                    <div class="mb-2 row experience-row">
                                        <div class="col-md-4">
                                            <input type="text" name="experiences[0][employer_name]" class="form-control" placeholder="Employer">
                                        </div>
                                        <div class="col-md-3">
                                            <input type="text" name="experiences[0][position]" class="form-control" placeholder="Position">
                                        </div>
                                        <div class="col-md-3">
                                            <input type="text" name="experiences[0][duration]" class="form-control" placeholder="Duration">
                                        </div>
                                        <div class="col-md-1">
                                ...
                                <div id="language-wrapper">
                                    <div class="mb-2 row language-row">
                                        <div class="col-md-3">
                                            <input type="text" name="languages[0][language]" class="form-control" placeholder="Language">
                                        </div>
                                        <div class="col-md-2">
                                            <input type="text" name="languages[0][understanding]" class="form-control" placeholder="Understanding">
                                        </div>
                                        <div class="col-md-2">
                                            <input type="text" name="languages[0][speaking]" class="form-control" placeholder="Speaking">
                                        </div>
                                        <div class="col-md-2">
                                            <input type="text" name="languages[0][writing]" class="form-control" placeholder="Writing">
                                        </div>
                                        <div class="col-md-1">
                                    ...
                                    <div class="mb-2 col-4">
                                        <div class="form-check">
                                            ...
                                            <label class=" form-check-label">
                                                {{ $doc->name }}
                                                @if($doc->is_mandatory)
                                                    <span class="ml-3 badge bg-danger">Mandatory</span>
                                                @endif
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="col-12">
                                    <div
                                        ...
                                        <button id="js-submit-btn" class="ml-auto btn btn-primary" type="submit">Register Candidate</button>
                                    </div>
                                </div>
                            </form>
                        </div>
