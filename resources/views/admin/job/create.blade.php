    ...
    <main id="js-page-content" role="main" class="page-content">
        ...
        <div class="subheader">
            <h1 class="subheader-title">
                <i class='subheader-icon fal fa-chart-area'></i> Create Job <span class='fw-300'></span>
            </h1>
        ...
        <div class="row">
            <div class="col-xl-12">
                <div id="panel-1" class="panel">
                    <div class="panel-hdr">
                        <h2>
                            {{-- Create <span class="fw-300"><i>job</i></span> --}}
                        </h2>
                            ...
                            <form action="{{ route('job.store') }}" enctype="multipart/form-data" method="post"
                                ...
                                <div class="mb-3 col-6">
                                    <div class="form-group">
                                        <label class="form-label" for="title">Job Title<span
                                                style="color: red">*</span></label>
                                        <input type="text" id="title" name="title" class="form-control"
                                            value="{{ old('title') }}">
                                        <div class="invalid-feedback">Job Title is required, you missed this one.</div>
                                        @error('title')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
