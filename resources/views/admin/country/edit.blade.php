...
<main id="js-page-content" role="main" class="page-content">
    ...
    <div class="subheader">
        <h1 class="subheader-Name">
            <i class='subheader-icon fal fa-chart-area'></i> Update Country  <span class='fw-300'></span>
        </h1>
    ...
    <div class="row">
        <div class="col-xl-12">
            <div id="panel-1" class="panel">
                <div class="panel-hdr">
                    <h2>
                        {{-- Update <span class="fw-300"><i>country</i></span> --}}
                    </h2>
                ...
                <div class="panel-container show">
                    <div class="panel-content">
                        ...
                        <form action="{{ route('country.update',$country->id) }}" enctype="multipart/form-data" method="post" id="user-form" class="smart-form row" autocomplete="off" >
                            @csrf
                            @method('put')
                            ...
                            <div class="mb-6 col-6">
                                <div class="form-group">
                                    <label class="form-label" for="country_name">Name <span style="color: red">*</span></label>
                                    <input type="text" id="country_name" style="margin-top: 2%" name="country_name" class="form-control" @if (isset($country->country_name)) value="{{ $country->country_name }}" @endif>
                            ...
                            <div class="mb-3 col-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" id="order" name="order" class="form-control" value="{{ $country->order }}">
                                    @error('order')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
