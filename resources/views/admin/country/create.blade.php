    ...
    <main id="js-page-content" role="main" class="page-content">
        ...
        <div class="subheader">
            <h1 class="subheader-title">
                <i class='subheader-icon fal fa-chart-area'></i> Create Country <span class='fw-300'></span>
            </h1>
        ...
        <div class="row">
            <div class="col-xl-12">
                <div id="panel-1" class="panel">
                    <div class="panel-hdr">
                        <h2>
                            {{-- Create <span class="fw-300"><i>Country</i></span> --}}
                        </h2>
                            ...
                            <form action="{{ route('country.store') }}" enctype="multipart/form-data" method="post"
                                ...
                                <div class="mb-3 col-6">
                                    <div class="form-group">
                                        <label class="form-label" for="country_name">Country Name<span
                                                style="color: red">*</span></label>
                                        <input type="text" id="country_name" name="country_name" class="form-control"
                                            value="{{ old('country_name') }}">
                                        <div class="invalid-feedback">Country Name is required, you missed this one.</div>
                                        @error('country_name')
