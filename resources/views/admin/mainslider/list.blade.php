...
<main id="js-page-content" role="main" class="page-content">
    ...
    <div class="subheader">
        <h1 class="subheader-title">
            <i class='subheader-icon fal fa-chart-area'></i> Main Slider<span class='fw-300'></span>
        </h1>
    ...
    <div class="row">
        <div class="col-xl-12">
            <div id="panel-1" class="panel">
                <div class="panel-hdr">
                    <h2>
                        {{-- Main Slider <span class="fw-300"><i>list</i></span> --}}
                    </h2>
                </div>
                <div class="panel-container show">
                    <div class="panel-content">
                        ...
                        <table id="dt-basic-example" class="table table-bordered table-hover table-striped w-100">
                            <thead>
                                <th style="width: 5%;">#</th>
                                <th style="width: 60%;">Desktop Image</th>
...
<script>
    $(document).ready(function() {
        var table = $('#dt-basic-example').dataTable({
            ...
            searching: true,
            ajax: {
                url: "{{ route('main-slider.get-main-slider') }}",
